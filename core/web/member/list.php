...
class List_EweiShopV2Page extends WebPage 
{
	...
	public function post() 
	{
		...
		$mobile = trim($_GPC['mobile']);
 		...
 		if(!empty($name) &&!empty($mobile) &&!empty($pwd)){
 		...
 		$data = array('uniacid' => $_W['uniacid'], 'mobile' => $mobile, 'nickname' => $name, 'openid' => $openid, 'pwd' => md5($pwd . $salt), 'salt' => $salt, 'createtime' => time(), 'mobileverify' => 1, 'comefrom' => 'mobile');
